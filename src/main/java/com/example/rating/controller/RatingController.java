...
public class RatingController {
    ...
    @GetMapping("users/{userIdId}")
    public ResponseEntity<List<Rating>> getRatingByUserId(@PathVariable String userIdId){
        List<Rating> ratings = ratingService.getRatingByUserId(userIdId);
